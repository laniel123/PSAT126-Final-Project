...
summary(AIC_model)
```
In class we saw different techniques and criterion to find best model. You can use any
method and technique you prefer (e.g., backward elimination using AIC or stepwise regression using AIC or backward elimination using BIC criterion) to find the best model
